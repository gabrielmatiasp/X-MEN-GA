...
OBJETIVO 2 - quando passar o mouse em cima do personagem na listagem, trocar a imagem, o nome e a descrição do personagem grande
   ...
   //BJETIVO 1 - quando passar o mouse em cima do personagem na listagem, devemos selecioná-lo
   //passo 1 - pegar os personagens no JS pra poder verificar quando o usuário passar o mouse em cima de um deles
...
personagem.addEventListener('mouseenter', () => {
   ...
   //passo 3 - verificar se já exista um personagem selecionado, se sim, devemos remover a seleção dele 
     ...
     // passo 3 - alterar o nome do personagem grande
     const nomePeronagem = document.getElementById('nome-personagem');
     nomePeronagem.innerText = personagem.getAttribute('data-name');
